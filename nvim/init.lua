...
vim.keymap.set('n', '<leader>xX', ':Trouble diagnostics toggle filter.buf=0<CR>', { silent = true, desc = "Buffer diagnostics" })
vim.keymap.set('n', '<leader>cs', ':Trouble symbols toggle focus=false<CR>', { silent = true, desc = "Symbols" })
vim.keymap.set('n', '<leader>cl', ':Trouble lsp toggle focus=false win.position=right<CR>', { silent = true, desc = "LSP definitions" })
